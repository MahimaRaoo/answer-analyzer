...
def sentence_similarity(sentence1, sentence2):
    ...
    synsets2 = [ss1 for ss1 in synsets2 if ss1]
    ...
    for synset in synsets1:
        ...
        for synsett in synsets2:
            best_score =synset.wup_similarity(synsett)
...
for sentence in sentences:
    ...
    print(sentence_similarity(sentence, focus_sentence))
